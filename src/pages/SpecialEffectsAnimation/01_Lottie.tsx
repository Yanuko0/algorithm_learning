...
import specialEffectsAnimation_img from "@/pages/SpecialEffectsAnimation/assets/img/specialEffectsAnimation_img"
                ...
                <div className="diagrambox">
                    ...
                    <p className="diagram">
                        <div className="commentaryBox">
                            ...
                            >
                                <Image src={specialEffectsAnimation_img.Lottie_01} alt="Lottie_01" />
